...
//
//	mockgen -typed -package quic -self_package github.com/minchieh-fay/quic-go -self_package github.com/minchieh-fay/quic-go -destination mock_packetconn_test.go net PacketConn
//
